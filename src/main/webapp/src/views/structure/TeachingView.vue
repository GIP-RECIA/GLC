...
const { currentPersonne, teachingStaffList } = storeToRefs(personneStore);
...
<template>
  <v-container fluid>
    ...
    <filieres-layout
      :filieres="currentEtab?.teachingStaff"
      :without-functions="currentEtab?.withoutFunctionsTeaching"
