...
package fr.recia.db.repositories.personne;
...
public interface APersonneRepository<T extends APersonne> extends AbstractRepository<T, Long> {
    ...
    @Query("SELECT new fr.recia.db.dto.personne.DatabasePersonneDto(ap.id, ap.etat, ap.categorie, " +
    ...
    @Query("SELECT new fr.recia.db.dto.personne.DatabasePersonneDto(ap.id, ap.etat, ap.categorie, " +
        ...
        "FROM APersonne ap " +
        "WHERE (ap.cn LIKE concat('%', :name, '%') OR ap.email LIKE concat('%', :name, '%')) " +
        "AND ap.categorie in (fr.recia.db.enums.CategoriePersonne.Enseignant, " +
        "fr.recia.db.enums.CategoriePersonne.Non_enseignant_collectivite_locale, " +
        "fr.recia.db.enums.CategoriePersonne.Non_enseignant_etablissement, " +
        "fr.recia.db.enums.CategoriePersonne.Non_enseignant_service_academique) " +
        "ORDER BY ap.cn, ap.sn")
