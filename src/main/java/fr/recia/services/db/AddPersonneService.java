...
import fr.recia.db.entities.common.CleJointure;
import fr.recia.db.entities.education.Enseignement;
import fr.recia.db.entities.education.MEF;
import fr.recia.db.entities.education.MappingEleveEnseignement;
import fr.recia.db.entities.gestion.AnneeScolaire;
import fr.recia.db.entities.gestion.GenUID;
import fr.recia.db.entities.groupe.AGroupeOfFoncClasseGroupe;
import fr.recia.db.entities.groupe.Classe;
import fr.recia.db.entities.groupe.MappingAGroupeAPersonne;
import fr.recia.db.entities.groupe.MappingAGroupeAPersonneEnseignement;
import fr.recia.db.entities.groupe.MappingAGroupeAPersonneEnseignementId;
import fr.recia.db.entities.personne.APersonne;
import fr.recia.db.entities.personne.Eleve;
import fr.recia.db.entities.personne.Enseignant;
import fr.recia.db.entities.personne.Login;
import fr.recia.db.entities.personne.NonEnseignantEtablissement;
import fr.recia.db.entities.personne.NonEnseignantServiceAcademique;
import fr.recia.db.entities.structure.AStructure;
import fr.recia.db.enums.CategoriePersonne;
import fr.recia.db.enums.Civilite;
import fr.recia.db.enums.Etat;
import fr.recia.db.enums.Sexe;
import fr.recia.db.repositories.education.EnseignementRepository;
import fr.recia.db.repositories.education.MEFRepository;
import fr.recia.db.repositories.gestion.AnneeScolaireRepository;
import fr.recia.db.repositories.gestion.GenUIDRepository;
import fr.recia.db.repositories.groupe.AGroupeOfFoncClasseGroupeRepository;
import fr.recia.db.repositories.groupe.ClasseRepository;
import fr.recia.db.repositories.groupe.MappingAGroupeAPersonneEnseignementRepository;
import fr.recia.db.repositories.groupe.MappingAGroupeAPersonneRepository;
import fr.recia.db.repositories.personne.APersonneRepository;
import fr.recia.db.repositories.personne.LoginRepository;
import fr.recia.db.repositories.structure.AStructureRepository;
import fr.recia.services.cache.CacheInvalidationService;
import fr.recia.services.creation.NameCalculator;
import fr.recia.services.creation.PasswordGenerator;
import fr.recia.services.creation.UidFactory;
import fr.recia.services.exceptions.EmailAlreadyExistsException;
