...
import fr.recia.ldap.ExternalGroupHelper;
import fr.recia.ldap.mappers.PeopleResponseAttributesMapper;
import fr.recia.ldap.mappers.StructureSirenDomainAttributesMapper;
import fr.recia.ldap.repository.LdapGroupDao;
import fr.recia.ldap.repository.LdapPeopleDao;
import fr.recia.ldap.repository.LdapStructureDao;
...
public class LDAPConfiguration {
    ...
    public LDAPConfiguration(AppProperties appProperties) {
        this.ldapProperties = appProperties.getLdap();
    }
